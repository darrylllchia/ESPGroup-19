...
#'Output:
#'  A vector of Ps after each iteration
#'  A list containing a matrix(inft) of the simulated number of deaths after each iteration
#'  The converged t0
#'Note:
...
#'  It compares the converged vector of days of death(t0) with data generated from a poisson distribution.
#'  Use The actual number of deaths of each day as the lambda parameter for each day.
